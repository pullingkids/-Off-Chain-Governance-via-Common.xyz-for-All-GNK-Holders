...
As Gonka grows — more miners, more developers, more GNK holders — this mismatch will only become more acute. Community decisions should be made by the community.
...
INC4 contributes initial deployment and configuration at no cost. A separate budget proposal for mainnet deployment and contract audit will be submitted once the implementation scope is confirmed.
